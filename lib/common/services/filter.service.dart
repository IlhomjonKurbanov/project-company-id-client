...
mixin FilterService {
  ...
  static Future<List<ProjectModel>> getFilteredProjects(String userId) async {
    final Response<dynamic> res =
  ...
  static Future<List<UserModel>> getProjectsFilteredUsers(
  ...
  static Future<List<StackModel>> getProjectsFilteredStack(
      String userId) async {
